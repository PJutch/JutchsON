...
TEST(Escape, escapeStrChar) {
    EXPECT_EQ(JutchsON::escapeStrChar("a", 0), "a");
}

TEST(Escape, escapeStrCharSlash) {
    EXPECT_EQ(JutchsON::escapeStrChar("\\", 0), "\\\\");
}

TEST(Escape, escapeStrCharQuote) {
    EXPECT_EQ(JutchsON::escapeStrChar("\"", 0), "\\\"");
}

TEST(Escape, escapeStrCharEscape) {
    EXPECT_EQ(JutchsON::escapeStrChar("\n", 0), "\\n");
}
