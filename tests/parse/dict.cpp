...
TEST(Dict, parseDictMultilineNoValueLast) {
    std::vector<std::pair<JutchsON::StringView, JutchsON::StringView>> result{{"abc", "de"}, {"gh", ""}};
    EXPECT_EQ(JutchsON::parseDict("abc  de\ngh"), result);
}
